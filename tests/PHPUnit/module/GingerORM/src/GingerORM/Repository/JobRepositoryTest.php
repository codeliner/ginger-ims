...
class JobRepositoryTest extends DoctrineTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->createEntitySchema('GingerORM\Entity\Task');

        $this->object = $this->getTestEntityManager()->getRepository('GingerORM\Entity\Job');
    ...
    /**
     * @covers GingerORM\Repository\JobRepository::getJobNames
     */
    ...
    /**
     * @covers GingerORM\Repository\JobRepository::loadJob
     */
    ...
    /**
     * @covers GingerORM\Repository\JobRepository::saveJob
     */
