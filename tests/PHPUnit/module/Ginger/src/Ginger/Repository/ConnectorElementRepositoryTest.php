...
class ConnectorElementRepositoryTest extends DoctrineTestCase
{
    ...
    {
        $this->createEntitySchema('Ginger\Entity\ConnectorElement');
        $this->object = $this->getTestEntityManager()->getRepository('Ginger\Entity\ConnectorElement');
        $this->object->setServiceLocator(self::getApplication()->getServiceManager());
    }

    /**
     * @covers Ginger\Repository\ConnectorElementRepository::registerMapper
     */
    ...
    /**
     * @covers Ginger\Repository\ConnectorElementRepository::registerSource
     */
    ...
    /**
     * @covers Ginger\Repository\ConnectorElementRepository::registerTarget
     */
