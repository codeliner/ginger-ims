...
return array(
    ...
    'HEADLINE::JOBS::TASK'                   => 'Aufgabe',
    'HEADLINE::JOBS::TASKS'                  => 'Aufgaben',
    'HEADLINE::JOBS::TASK::ADD'              => 'Aufgabe hinzufügen',
    'HEADLINE::JOBS::TASK::EDIT'             => 'Aufgabe bearbeiten',
    ...
    'JOBS::BUTTON::TASK::ADD'                => 'Aufgabe hinzufügen',
    ...
    'JOBS::LABEL::SUCCESSFUL_TASKS'          => 'erfolgreiche Aufgaben',
    ...
    'JOBS::JOBRUN::TASK::STARTED'               => ':number. Aufgabe gestartet.',
    'JOBS::JOBRUN::TASK::END'                   => ':number. Aufgabe :status beendet.',
    'JOBS::JOBRUN::TASK::END_ITEMS'             => 'Es wurden :insertedItems / :totalItems :pluralItemName :pastAction.',
    ...
    //jobrun errors
    'JOBS::JOBRUN::ERROR::START_TASK'           => "Die Aufgabe mit der id: \"%s\" wurde nach dem Start abgebrochen.\n%s",
    ...
    // tasks
    'TASK::SOURCE::SELECTONE'          => 'Quelle auswählen',
    'TASK::TARGET::SELECTONE'          => 'Ziel auswählen',
    'TASK::MAPPER::HEADLINE'           => 'Attribut-Zuordnung',
    'TASK::SAVED_SUCCESSFUL'           => 'Aufgabe erfolgreich gespeichert!',
    'TASK::ITEM_NAME::dataset'         => array(
                                                'Datensätze',
                                                'Datensatz'
                                            ),
    'TASK::ITEM_NAME::file'            => array(
                                                'Dateien',
                                                'Datei'
                                            ),
    'TASK::TARGET_ACTION::import'      => 'importieren',
    'TASK::TARGET_ACTION_PAST::import' => 'importiert',
    'TASK::TARGET_ACTION::move'        => 'verschieben',
    'TASK::TARGET_ACTION_PAST::move'   => 'verschoben',
    'TASK::TARGET_ACTION::write'        => 'schreiben',
    'TASK::TARGET_ACTION_PAST::write'   => 'geschrieben',
    //errors
