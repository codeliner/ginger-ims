...
class JobRun
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GingerORM\Entity\Job", cascade={"persist", "merge"}, fetch="LAZY")
     */
    private $job;

    /**
     * @ORM\OneToMany(targetEntity="GingerORM\Entity\TaskRun", mappedBy="jobRun", cascade={"persist"}, orphanRemoval=true)
     */
    private $taskRuns;
